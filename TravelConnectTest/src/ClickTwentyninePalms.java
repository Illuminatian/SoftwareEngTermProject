...
public class ClickTwentyninePalms {
  ...
  @Test
  public void testClickTwentyninepalms() throws Exception {
    driver.get("http://travelconnect.ddns.net/Trip");
    Thread.sleep(2000);
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Hawaii'])[1]/following::img[1]")).click();
    Thread.sleep(2000);
