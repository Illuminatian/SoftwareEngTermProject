...
public class PostMessage {
  ...
  public void setUp() throws Exception {
    ...
    baseUrl = "https://travelconnect.ddns.net/";driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  }
  ...
  public void testPostMessage() throws Exception {
    ...
    Thread.sleep(2000);
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='A Beautiful Place'])[1]/following::img[1]")).click();
    Thread.sleep(2000);
    driver.findElement(By.id("txtMessage")).click();
    driver.findElement(By.id("txtMessage")).clear();
    driver.findElement(By.id("txtMessage")).sendKeys("Let's Eat Lobster!");
    Thread.sleep(2000);
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Post a trip message:'])[1]/following::input[2]")).click();
    Thread.sleep(3000);
  }
