...
public class SubscribeToTrip {
  ...
  @Test
  public void testSubscribeToTrip() throws Exception {
    ...
    Thread.sleep(2000);
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Explore Trips'])[1]/following::i[2]")).click();
    Thread.sleep(2000);
    driver.findElement(By.id("chkSubscribed")).click();
    Thread.sleep(1000);
